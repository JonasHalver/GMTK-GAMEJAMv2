...
Shader "Triplanar"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			c.rgb = ( saturate( ( ( saturate( ( temp_output_3_0_g32 / fwidth( temp_output_3_0_g32 ) ) ) + saturate( ( temp_output_3_0_g33 / fwidth( temp_output_3_0_g33 ) ) ) + saturate( ( temp_output_3_0_g31 / fwidth( temp_output_3_0_g31 ) ) ) ) / 3.0 ) ) * ( ase_lightColor * ase_lightAtten ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18200
203;259;1165;551;2551.16;409.5032;2.738649;True;False
...
ASEEND*/
//CHKSM=3600BB6CA6C2B62F2FB25DA0F3FF7064BC449C60