...
Shader "Triplanar"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_3_0_g32 = ( _8 - temp_output_55_0 );
			float temp_output_3_0_g33 = ( _Float1 - temp_output_55_0 );
			...
			float4 temp_output_22_0 = ( ( ( _Color0 * triplanar11 ) * abs( ase_vertexNormal.x ) ) + ( ( _Color1 * triplanar12 ) * abs( ase_vertexNormal.y ) ) + ( ( _Color2 * triplanar13 ) * abs( ase_vertexNormal.z ) ) );
			c.rgb = ( ( saturate( ( ( saturate( ( temp_output_3_0_g32 / fwidth( temp_output_3_0_g32 ) ) ) + saturate( ( temp_output_3_0_g33 / fwidth( temp_output_3_0_g33 ) ) ) + saturate( ( temp_output_3_0_g31 / fwidth( temp_output_3_0_g31 ) ) ) ) / 3.0 ) ) * ( ase_lightColor * ase_lightAtten ) ) * temp_output_22_0 ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18200
-261;604;1920;994;2610.945;-12.94154;2.163151;True;False
Node;AmplifyShaderEditor.CommentaryNode;59;-977.331,1166.136;Inherit;False;812;304;Comment;3;68;64;54;Attenuation and Ambient;1,1,1,1;0;0
Node;AmplifyShaderEditor.LightAttenuation;54;-909.976,1372.642;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;25;-2217.77,392.7233;Inherit;False;Property;_Vector2;Vector 2;5;0;Create;True;0;0;False;0;False;1,1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;24;-1915.421,160.7875;Inherit;False;Property;_Vector1;Vector 1;10;0;Create;True;0;0;False;0;False;1,1;0.15,0.15;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;61;-1452.315,640.8701;Inherit;True;Step Antialiasing;-1;;33;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;60;-1408.525,926.6871;Inherit;True;Step Antialiasing;-1;;32;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;63;-945.7862,657.1013;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-746.605,778.8702;Inherit;False;Constant;_Float2;Float 2;5;0;Create;True;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;31;-1267.445,193.4349;Inherit;False;Property;_Color2;Color 2;9;0;Create;True;0;0;False;0;False;0.8177759,0.3443396,1,0;0.1627646,0.1005696,0.1886792,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;13;-2013.408,297.0457;Inherit;True;Spherical;World;False;Top Texture 2;_TopTexture2;white;3;None;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Triplanar Sampler;False;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;30;-1243.302,-78.11605;Inherit;False;Property;_Color1;Color 1;8;0;Create;True;0;0;False;0;False;0.8177759,0.3443396,1,0;0.07450441,0.06884122,0.1226415,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;28;-1272.59,-370.0211;Inherit;False;Property;_Color0;Color 0;7;0;Create;True;0;0;False;0;False;0.8177759,0.3443396,1,0;0.2068999,0.1548594,0.2264151,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightColorNode;64;-846.0141,1197.578;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleDivideOpNode;67;-578.7173,740.8677;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;68;-321.3303,1214.136;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;77;-272.2631,758.1255;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;57.44261,693.886;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;22;56.48014,-20.68973;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;221.4138,307.3085;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;26;463.1711,627.4184;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F526F16E04C42672BA0B49220D800C6397427F1A