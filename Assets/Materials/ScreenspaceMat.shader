...
Shader "ScreenspaceMat"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 panner11 = ( mulTime9 * _Direction + ( ase_screenPosNorm * float4( float2( 1,2 ), 0.0 , 0.0 ) ).xy);
			o.Alpha = ( tex2D( _MainTex, uv_MainTex ).a * tex2D( _TextureSample1, panner11 ) ).r;
		}
...
/*ASEBEGIN
Version=18200
152;317;1371;702;666.9593;393.4781;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;6;-395.0933,523.6898;Inherit;False;Property;_Speed1;,;1;0;Create;True;0;0;False;0;False;0.1;-0.21;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;1;-323.5,-187;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;4;-311.65,48.7125;Inherit;False;Constant;_Vector0;Vector 0;0;0;Create;True;0;0;False;0;False;1,2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-117.0592,-60.17828;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SamplerNode;17;137.7408,11.32199;Inherit;True;Property;_MainTex;MainTex;5;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;7;-519.4542,259.7431;Inherit;False;Property;_Tiling;Tiling;4;0;Create;True;0;0;False;0;False;1,1;1,2.22;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-312.8313,251.0941;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=BC8076D790B07797C7226658FFF326B838AF8EB1